...
if("TRUE" STREQUAL "TRUE")
  set(lab4_cam_SOURCE_PREFIX /home/cc/ee106a/fl21/class/ee106a-acq/ros_workspaces/robotics-ball-throwing/src/lab4_cam)
  set(lab4_cam_DEVEL_PREFIX /home/cc/ee106a/fl21/class/ee106a-acq/ros_workspaces/robotics-ball-throwing/devel)
  set(lab4_cam_INSTALL_PREFIX "")
  set(lab4_cam_PREFIX ${lab4_cam_DEVEL_PREFIX})
else()
  set(lab4_cam_SOURCE_PREFIX "")
  set(lab4_cam_DEVEL_PREFIX "")
  set(lab4_cam_INSTALL_PREFIX /home/cc/ee106a/fl21/class/ee106a-acq/ros_workspaces/robotics-ball-throwing/install)
...
if(NOT "/home/cc/ee106a/fl21/class/ee106a-acq/ros_workspaces/robotics-ball-throwing/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lab4_cam' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cc/ee106a/fl21/class/ee106a-acq/ros_workspaces/robotics-ball-throwing/src/lab4_cam/${idir}'.  ${_report}")
    endif()
